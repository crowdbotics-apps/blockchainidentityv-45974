"""
Django settings for blockchainidentityv_45974 project.
...
ROOT_URLCONF = 'blockchainidentityv_45974.urls'
...
WSGI_APPLICATION = 'blockchainidentityv_45974.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blockchainidentityv_45974 API",
    "DESCRIPTION": "API documentation for blockchainidentityv_45974 App",
    "VERSION": "v1",
}
